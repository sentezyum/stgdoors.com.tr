...
<body class="body">
	...
	<div class="ortala">
		...
		<div id="menu_container">
			...
			<div class="ustmenu">
				<ul>
					...
					<li><a href="iletisim.asp">Contact Us</a></li>				</ul>
			</div>
		</div>
		<div id="icerik" style="background-color:#ffffff">
			...
			<div id="icerik_sayfa">
				<div class="img_golge">
					<img alt="STG Doors Hakkında" src="_img/galeri.jpg" style="left: 0px; top: 0px" />
				</div>	
				<h5>Gallery</h5>
				&nbsp;<p>İşletmemizden ve çalışma ortammızdan derlediğimiz görüntülerle hakkımızda daha iyi fikir sahibi olmanızı umuyoruz.</p>
			...
			<div class="sag_menu">
				<ul>
					...
					<li><a href="galeri.asp">Photo Gallery</a></li>
				</ul>
			</div>
