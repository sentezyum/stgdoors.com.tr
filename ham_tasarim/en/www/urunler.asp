...
<body class="body">
	...
	<div style="float:left; width:100%">
	  	<div class="urun" onclick="changeVisibility()"  >
	 		<p>
			<img style="margin-left:-15px" alt="" height="300" src="_img/urunler/en/STG%20Maxi%20EN.jpg" width="300" /></p>
		
	  	</div>
	  	<div class="urun" onclick="changeVisibility2()"  >
		
			
			<img   alt="" height="300" src="_img/urunler/en/STG%20Mini%20Transparan.jpg" width="300" />
		</div>
		<div class="urun" onclick="changeVisibility3()"  >
		
			
			<img  alt="" height="300" src="_img/urunler/en/STG%20Mini%20Glass%20EN.jpg" width="300" />
		</div>
	</div>
<div style="clear:both; float:left;" class="urundetay">
	<div id="container">
				...
				<div id="urun_nav">
				<a target="_blank" href="technicaldoc/stg%20maxi%20-%20en.pdf"><img alt="PDF Technical Documentation"  style="margin: 0px 5px -12px 05px" width="32px" src="_img/pdf_ico1.png" height="32px" />Technical Documentation</a>
				<a target="_blank" href="technicaldoc/STG%20Doors%20e-katalog%202013%20EN.pdf"><img alt=""  style="margin: 0px 5px -12px 5px" width="32px" src="_img/pdf_ico1.png" height="32px" />Catolog</a>
				</div>
	...
	<div id="container2">
				...
				<div id="urun_nav">
				<a target="_blank" href="technicaldoc/stg%20mini%201%20-%20en.pdf"><img alt="PDF Technical Documentation"  style="margin: 0px 5px -12px 05px" width="32px" src="_img/pdf_ico1.png" height="32px" />Technical Documentation 1</a>
				<a target="_blank" href="technicaldoc/stg%20mini%202%20-%20en.pdf"><img alt="PDF Technical Documentation"  style="margin: 0px 5px -12px 05px" width="32px" src="_img/pdf_ico1.png" height="32px" />Technical Documentation 2</a>
				<a target="_blank"  href="technicaldoc/STG%20Doors%20e-katalog%202013%20EN.pdf"><img alt=""  style="margin: 0px 5px -12px 5px" width="32px" src="_img/pdf_ico1.png" height="32px" />Catolog</a>
				</div>
...
<div style="float:left; clear:both;" id="anaurun" >
	<div style="float:left; width:100%;">
	  	<div class="urun" onclick="changeVisibility4()"  >
	  		...
	  		<img alt="" height="300" src="_img/urunler/en/STG%20Sliding%20Door%20EN.jpg" width="300" /></div>
	  	<div class="urun" onclick="changeVisibility5()"  >
		
		 
			<img alt="" height="300" src="_img/urunler/en/STG%20Dik%20Bombe%20Sürgü%20Kapı.jpg" width="300" /></div>
		<div class="urun" onclick="changeVisibility6()"  >
		
			<img alt="" height="300" src="_img/urunler/en/STG%20Yatay%20Bombe%20Sürgü%20Kapı.jpg" width="300" /></div>
	</div>
<div style="clear:both; float:left;" class="urundetay">
	<div id="container4">
				<h5>Frame Door - STG Sliding Door</h5>
				<div id="urun_nav">
				<a target="_blank" href="technicaldoc/stg%20sliding%20M1250%20-%20en.pdf"><img alt="PDF Technical Documentation"  style="margin: 0px 5px -12px 05px" width="32px" src="_img/pdf_ico1.png" height="32px" />Technical Documentation 1	</a>
								<a target="_blank" href="technicaldoc/stg%20sliding%20M1875%20-%20en.pdf"><img alt="PDF Technical Documentation"  style="margin: 0px 5px -12px 05px" width="32px" src="_img/pdf_ico1.png" height="32px" />Technical Documentation 2	</a>
				<a target="_blank"  href="technicaldoc/STG%20Doors%20e-katalog%202013%20EN.pdf"><img alt=""  style="margin: 0px 5px -12px 5px" width="32px" src="_img/pdf_ico1.png" height="32px" />Catolog</a>
				</div>
	...
	<div id="container5">
				...
				<div id="urun_nav">
				<a target="_blank" href="technicaldoc/stg%20steep%20sliding%20M1250%20-%20en.pdf"><img alt="PDF Technical Documentation"  style="margin: 0px 5px -12px 05px" width="32px" src="_img/pdf_ico1.png" height="32px" />Technical Documentation 1</a>
				<a target="_blank" href="technicaldoc/stg%20steep%20camber%20sliding%20M1875%20-%20en.pdf"><img alt="PDF Technical Documentation"  style="margin: 0px 5px -12px 05px" width="32px" src="_img/pdf_ico1.png" height="32px" />Technical Documentation 2</a>
				<a target="_blank"  href="technicaldoc/STG%20Doors%20e-katalog%202013%20EN.pdf"><img alt=""  style="margin: 0px 5px -12px 5px" width="32px" src="_img/pdf_ico1.png" height="32px" />Catolog</a>
				</div>
	...
	<div id="container6">
			...
			<h5 >Frame Door - STG Curved Camber Sliding Door</h5>
				<div id="urun_nav">
				<a target="_blank"href="technicaldoc/stg%20curved%20concave%20-%20en.pdf"><img alt="PDF Technical Documentation"  style="margin: 0px 5px -12px 05px" width="32px" src="_img/pdf_ico1.png" height="32px" />Technical Documentation 1</a>
				<a target="_blank"href="technicaldoc/stg%20curved%20chambered%20-%20en.pdf"><img alt="PDF Technical Documentation"  style="margin: 0px 5px -12px 05px" width="32px" src="_img/pdf_ico1.png" height="32px" />Technical Documentation 2</a>
				<a target="_blank" href="technicaldoc/STG%20Doors%20e-katalog%202013%20EN.pdf"><img alt=""  style="margin: 0px 5px -12px 5px" width="32px" src="_img/pdf_ico1.png" height="32px" />Catolog</a>
				</div>
