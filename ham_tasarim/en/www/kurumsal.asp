	...
	<div class="ortala">
		...
		<div id="icerik" style="background-color:#ffffff">
			...
			<div id="tam_icerik_sayfa" style="margin-left:-9px;">
				...
				<p>STG Doors -Glass doors and frame systems, increases the e 
				ciency of industrial refrigeration and protection of nature.</p>
				<p>STG DOOR SYSTEMS ‘’ rapidly advancing sector , qualifed team 
				, designer , pioneering and innovative structure , the principle 
				of production and service quality , pre-sales and after-sales 
				service e ective and fast with an understanding of can produce 
				costom<br />
				solutions , so much di erent a company.’’</p>
				...
				<div style="text-align:center; background-image:url('_img/header_bg.jpg'); background-repeat:repeat-x; background-position:left top; padding-top:30px; margin-top:30px; width:100%; float:left">
					<img alt="STG Logo" src="_img/stg_gri_logo.png" /> <br />
					<h4 style="font-size:15px; width:100%">
					OUR BUSINESS IS
TO ADD</h4>
					<h5>
					VALUE TO OUR PARTNER COMPANIES. </h5>
				</div>
			...
			<div class="sag_menu">
				<ul>
					<li><a href="kurumsal.asp">Company Profile</a></li>
					<li><a href="duyurular.asp">Announcements and News</a></li>
				</ul>
			</div>
