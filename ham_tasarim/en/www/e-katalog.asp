...
<body class="body">
	...
	<div class="ortala">
		...
		<div id="iletisim">
			...
			<div style=" border-right:1px #FFFFFF dotted; float:left; padding:5px 5px 5px 5px; margin-top:5px; height:18px">
				<a href="http://en.stgdoors.com.tr/">
				<img alt="English" src="_img/uk.gif" /></a>
				<a href="http://ru.stgdoors.com.tr/">
				<img alt="Russian" src="_img/ru.gif" /></a>
				<a href="http://www.stgdoors.com.tr/">
				<img alt="Türkçe" src="_img/tr.gif" /></a>
			</div>
			<div style="float:left; padding:0px 5px 5px 5px; margin-top:5px; height:18px">
				
				<a href="https://www.facebook.com/StgDoorSystems">
				<img alt="Facebook" src="_img/facebook.png" /></a>
			</div>
		</div>
		<div id="menu_container">
			...
			<div class="ustmenu">
				<ul>
					...
					<li><a href="e-katalog.asp">E-catalog</a></li>
		...
		<div id="icerik" style="background-color:#ffffff">
			...
			<div id="icerik_sayfa">
				...
				<a target="_blank" href="technicaldoc/STG-doors-e-catalog-en.pdf">
					<img alt=""  style="margin: 0px 5px -12px 5px" width="32px" src="_img/pdf_ico1.png" height="32px" />Catolog</a>
				</div>

				<h5>Frame Door - STG Maxi</h5>
				<div id="urun_nav">
				<a target="_blank" href="technicaldoc/stgmaxi.pdf">
					<img alt="PDF Teknik Döküman"  style="margin: 0px 5px -12px 05px" width="32px" src="_img/pdf_ico1.png" height="32px" />Technical Documentation</a>
				...
				<div id="urun_nav">
				<a target="_blank" href="technicaldoc/stgmidi.pdf">
					<img alt="PDF Teknik Döküman"  style="margin: 0px 5px -12px 05px" width="32px" src="_img/pdf_ico1.png" height="32px" />Technical Documentation</a>
				...
				<div id="urun_nav">
				<a  target="_blank" href="technicaldoc/stg-midi-combi.pdf">
					<img alt="PDF Teknik Döküman"  style="margin: 0px 5px -12px 05px" width="32px" src="_img/pdf_ico1.png" height="32px" />Technical Documentation</a>
				
				</div>
				
				<h5>Frame Door - STG Sling Door</h5>
				<div id="urun_nav">
				<a target="_blank" href="http://stgdoors.com.tr/_img/urunler/surgulu.pdf">
					<img alt="PDF Teknik Döküman"  style="margin: 0px 5px -12px 05px" width="32px" src="_img/pdf_ico1.png" height="32px" />Technical Documentation</a>
				...
				<div id="urun_nav">
				<a target="_blank" href="technicaldoc/dikbombe1250-1875.pdf">
					<img alt="PDF Teknik Döküman"  style="margin: 0px 5px -12px 05px" width="32px" src="_img/pdf_ico1.png" height="32px" />Technical Documentation</a>
				
				</div>
				
				<h5 >Frame Door - STG Horizontal Cambered Sliding Door</h5>
				<div id="urun_nav">
			...
			<div id="navigasyon" style="float:right; margin-top:25px; margin-right:15px; width:350px; text-align:right">
					...
					<img alt="Geri" src="_img/back1.jpg" /></a>
					<a href="#logo">
					<img alt="Başa Dön" src="_img/top1.jpg" /></a>
			</div>
		...
		<div id="footer">
			...
			<div id="markalar">
			<a href="#">
				<img alt="Enerji Tasarrufu" src="_img/tasarruf.png" /></a>
			
			<a href="#" style="float:right">
				<img alt="A Sınıfı Enerji" src="_img/aenerji.png" /></a>
			...
			<div id="footer_menu">
				...
				<a href="http://www.atcgrup.com">
				<img alt="ATC Bilişim" style="margin:10px 10px 0px 0px; float:right" height="16" src="_img/atc.png" width="58" /></a>
			</div>
