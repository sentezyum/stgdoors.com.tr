	...
	<div class="ortala">
		...
		<div id="icerik" style="background-color:#ffffff">
			...
			<div id="tam_icerik_sayfa">
				...
				<h5>Hakkımızda</h5>
				<p>Endüstriyel Soğutma ve Endüstriyel Mutfak sektörü için %40 - %60  Enerji Verimliliği sağlayan , kullanımı kolay , ergonomik , çevre dostu , hijyenik ortamlar yaratan , üreticilerin ve kullanıcıların memnuniyetini yükselten , firma Ar – Ge departmanımızın geliştirdiği ; STG Cam Kapı ürünleri ile hizmet veriyoruz.</p>
				<p>Sadece yurt içi pazarında değil , uluslar arası pazarlarda da müşteri hedef ve beklentilerine ; kaliteli ekibi , kaliteli üretimi , kaliteli ürünleri ve kaliteli servisi ile satış öncesi ve sonrası kaliteli hizmeti sunarak , STG DOOR SYSTEMS her geçen gün büyümeye ve tercih edilen firma olmaya devam etmektedir.</p>
				<p>Dünden bugüne , bugünden yarına , yarından geleceğe kalite yolculuğunda ; ‘’işimiz çözüm ortağı olduğumuz firmalara değer katmaktır ‘’ ilke ve felsefesi ile STG DOOR SYSTEMS , 
					sektörün dinamiği , innovasyon örneği firma olarak daima yanınızdadır.</p>
				...
				<div style="text-align:center; background-image:url('_img/header_bg.jpg'); background-repeat:repeat-x; background-position:left top; padding-top:30px; margin-top:30px; width:100%; float:left">
					...
					<h5>İşimiz, çözüm ortağı olduğumuz firmalara</h5>
					<h5 style="font-size:26px">Değer Katmaktır</h5>
				</div>
			...
			<div id="navigasyon" style="clear:both;float:right; margin-top:25px; margin-right:15px; width:350px; text-align:right">
