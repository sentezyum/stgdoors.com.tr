		...
		<div id="icerik">
			<div id="slogan">
				<div style="float:left; margin-bottom:3px">
					<h1>от 40% до 60% экономии энергии </h1>
				</div>
				<div style=" clear:both"><h2>
					<span>STG Doors : Стеклянные двери и рамные системы </span> увеличивает эффективность холодильники и защиты на  природы.</h2>
				</div>
			<div id="buton1"><a href="urunler.asp">Продукция</a></div>
			</div>
