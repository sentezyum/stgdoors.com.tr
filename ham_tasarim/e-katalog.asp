	...
	<div class="ortala">
		...
		<div id="icerik" style="background-color:#ffffff">
			...
			<div id="icerik_sayfa">
				...
				<a target="_blank" href="technicaldoc/STG-doors-e-katalog-tr.pdf"><img alt=""  style="margin: 0px 5px -12px 5px" width="32px" src="_img/pdf_ico1.png" height="32px" />Katolog</a>
				</div>

				<h5>Frame Door - STG Maxi</h5>
				<div id="urun_nav">
				<a target="_blank" href="technicaldoc/stgmaxi.pdf"><img alt="PDF Teknik Döküman"  style="margin: 0px 5px -12px 05px" width="32px" src="_img/pdf_ico1.png" height="32px" />Teknik 
					döküman</a>
				<a target="_blank" href="technicaldoc/STG-doors-e-katalog-tr.pdf"><img alt=""  style="margin: 0px 5px -12px 5px" width="32px" src="_img/pdf_ico1.png" height="32px" />Katolog</a>
				</div>
				...
				<div id="urun_nav">
				<a target="_blank" href="technicaldoc/stgmidi.pdf"><img alt="PDF Teknik Döküman"  style="margin: 0px 5px -12px 05px" width="32px" src="_img/pdf_ico1.png" height="32px" />Teknik 
					döküman</a>
				<a target="_blank" href="technicaldoc/STG-doors-e-katalog-tr.pdf"><img alt=""  style="margin: 0px 5px -12px 5px" width="32px" src="_img/pdf_ico1.png" height="32px" />Katolog</a>
				</div>
				...
				<div id="urun_nav">
				<a  target="_blank" href="technicaldoc/stg-midi-combi.pdf"><img alt="PDF Teknik Döküman"  style="margin: 0px 5px -12px 05px" width="32px" src="_img/pdf_ico1.png" height="32px" />Teknik 
					döküman</a>
				<a target="_blank"href="technicaldoc/STG-doors-e-katalog-tr.pdf"><img alt=""  style="margin: 0px 5px -12px 5px" width="32px" src="_img/pdf_ico1.png" height="32px" />Katolog</a>
				</div>
				...
				<div id="urun_nav">
				<a target="_blank" href="http://stgdoors.com.tr/_img/urunler/surgulu.pdf"><img alt="PDF Teknik Döküman"  style="margin: 0px 5px -12px 05px" width="32px" src="_img/pdf_ico1.png" height="32px" />Teknik 
					döküman</a>
				<a target="_blank" href="technicaldoc/STG-doors-e-katalog-tr.pdf"><img alt=""  style="margin: 0px 5px -12px 5px" width="32px" src="_img/pdf_ico1.png" height="32px" />Katolog</a>
				</div>
				...
				<div id="urun_nav">
				<a target="_blank" href="technicaldoc/dikbombe1250-1875.pdf"><img alt="PDF Teknik Döküman"  style="margin: 0px 5px -12px 05px" width="32px" src="_img/pdf_ico1.png" height="32px" />Teknik 
					döküman</a>
				<a target="_blank" href="technicaldoc/STG-doors-e-katalog-tr.pdf"><img alt=""  style="margin: 0px 5px -12px 5px" width="32px" src="_img/pdf_ico1.png" height="32px" />Katolog</a>
				</div>
				...
				<div id="urun_nav">
				<a target="_blank" href="#"><img alt="PDF Teknik Döküman"  style="margin: 0px 5px -12px 05px" width="32px" src="_img/pdf_ico1.png" height="32px" />Teknik 
					döküman</a>
				<a target="_blank" href="technicaldoc/STG-doors-e-katalog-tr.pdf"><img alt=""  style="margin: 0px 5px -12px 5px" width="32px" src="_img/pdf_ico1.png" height="32px" />Katolog</a>
				</div>
